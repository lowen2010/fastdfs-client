...
import org.csource.common.PropertiesUtil;
...
public class ClientGlobal
{
	...
	/**
	 * for spring aoutowired bean init method
	 * default properties is fdfs_client.properties under resource source folder
	 * @throws FileNotFoundException
	 * @throws IOException
	 * @throws MyException
	 */
	public static void initMethod() throws FileNotFoundException, IOException, MyException{
		init("/fdfs_client.properties");
	}
	/**
	...
	public static void init(String conf_filename) throws FileNotFoundException, IOException, MyException
	{
  		...
  		propertiesUtil.loadProperties(conf_filename);
  		
		g_connect_timeout = propertiesUtil.getInteger("connect_timeout", DEFAULT_CONNECT_TIMEOUT);
  		...
  		g_network_timeout = propertiesUtil.getInteger("network_timeout", DEFAULT_NETWORK_TIMEOUT);
  		...
  		g_charset = propertiesUtil.getProperty("charset");
  		if (g_charset == null || g_charset.length() == 0)
  		{
  			g_charset = "ISO8859-1";
  		}
  		
  		szTrackerServers = propertiesUtil.getStrArray("tracker_server");
  		...
  		g_tracker_http_port = propertiesUtil.getInteger("http.tracker_http_port", 80);
  		g_anti_steal_token = propertiesUtil.getBoolean("http.anti_steal_token", false);
  		if (g_anti_steal_token)
  		{
  			g_secret_key = propertiesUtil.getProperty("http.secret_key");
  		}
	}
